        ...
        try:
            ...
            for n in range(1, nb_rows - 1):
                for m in range(1, nb_cols - 1):
                    part1 += (Bz[n * nb_cols + m] - Bz[(n - 1) * nb_cols + (m - 1)]) ** 2
                    part1 += (Bz[n * nb_cols + m] - Bz[(n - 1) * nb_cols + m]) ** 2
                    part1 += (Bz[n * nb_cols + m] - Bz[(n - 1) * nb_cols + (m + 1)]) ** 2

                    part1 += (Bz[n * nb_cols + m] - Bz[n * nb_cols + (m - 1)]) ** 2
                    part1 += (Bz[n * nb_cols + m] - Bz[n * nb_cols + m]) ** 2
                    part1 += (Bz[n * nb_cols + m] - Bz[n * nb_cols + (m + 1)]) ** 2
