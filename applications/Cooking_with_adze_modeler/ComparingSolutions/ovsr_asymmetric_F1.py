...
path_asymmetric_data_reduced = path_base / "Asymmetric" / "pareto_front_reduced.csv"
...
asym_data_generator_reduced = get_processed_line_asym(path_asymmetric_data_reduced)


data_asym = array([record for record in asym_data_generator])
data_asym_reduced = array([record for record in asym_data_generator_reduced])
...
data_asym_reduced = array(sorted(data_asym_reduced, key=operator.itemgetter(idxF1)))
...
plt.savefig(path_export_base / 'asymmetric_bestin-F1-f1-f2_reduced.png', dpi=550, bbox_inches='tight')
# plt.show()
...
plt.savefig(path_export_base / 'asymmetric_bestin-F1-f1-f3_reduced.png', dpi=550, bbox_inches='tight')
# plt.show()
...
plt.savefig(path_export_base / 'asymmetric_bestin-F1-f2-f3_reduced.png', dpi=550, bbox_inches='tight')
# plt.show()