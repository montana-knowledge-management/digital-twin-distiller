...
plt.savefig(path_export_base / 'symmetric_last100-f1-f2_reduced.png', dpi=550, bbox_inches='tight')
# plt.show()
...
plt.savefig(path_export_base / 'symmetric_last100-f1-f3_reduced.png', dpi=550, bbox_inches='tight')
# plt.show()
...
plt.savefig(path_export_base / 'symmetric_last100-f2-f3_reduced.png', dpi=550, bbox_inches='tight')
# plt.show()
