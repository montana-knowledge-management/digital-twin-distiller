...
data_sym_reduced = array(sorted(data_sym_reduced, key=operator.itemgetter(idxF2)))
...
plt.savefig(path_export_base / "symmetric_bestin-F2-f1-f2_reduced.png", dpi=550, bbox_inches="tight")
# plt.show()
...
plt.savefig(path_export_base / "symmetric_bestin-F2-f1-f3_reduced.png", dpi=550, bbox_inches="tight")
# plt.show()
...
plt.savefig(path_export_base / "symmetric_bestin-F2-f2-f3_reduced.png", dpi=550, bbox_inches="tight")
# plt.show()
