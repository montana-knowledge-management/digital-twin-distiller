...
from math import acos, atan2, cos, degrees, hypot, pi, radians, sin, fmod
...
class FrozenPermeability(BaseModel):
    ...
    def __call__(self, cleanup=True, devmode=False, timeout=10000):
        r_ = super(FrozenPermeability, self).__call__(cleanup=cleanup, devmode=devmode, timeout=timeout)
...
if __name__ == "__main__":
    ...
    with open(ModelDir.DATA / 'example.json', 'r', encoding='utf-8') as f:
        res_ = json.load(f)
