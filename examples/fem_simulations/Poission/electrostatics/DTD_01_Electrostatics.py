...
geo.Append(["line", 2, 3], leftdomain=1, rightdomain=0, bc="GammaD2")
geo.Append(["line", 3, 4], leftdomain=1, rightdomain=0, bc="GammaN2")
geo.Append(["line", 4, 7], leftdomain=2, rightdomain=0, bc="GammaN3")
geo.Append(["line", 7, 0], leftdomain=1, rightdomain=0, bc="GammaN4")
