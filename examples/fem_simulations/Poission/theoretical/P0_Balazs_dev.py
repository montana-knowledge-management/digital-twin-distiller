...
f = LinearForm(fes)
f += -(alpha*(alpha**2*(sqrt((x-x0)**2+(y-y0)**2)-r0)**2+1)-2*alpha**3*sqrt((x-x0)**2+(y-y0)**2)*(sqrt((x-x0)**2+(y-y0)**2)-r0))/(sqrt((x-x0)**2+(y-y0)**2)*(alpha**2*(sqrt((x-x0)**2+(y-y0)**2)-r0)**2+1)**2)*v*dx
