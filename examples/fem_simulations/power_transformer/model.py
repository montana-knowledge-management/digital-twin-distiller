...
class PowerTransformer(BaseModel):
    ...
    design_parameters = {
        "ff_in": 0,  # filling factor in the inner winding [%]
        ...
        "core_ins": 0,
    }  # core insulation distance between the core and the windings [mm]

    design_variables = {
        "core_diam": 0,  # core diameter in [mm]
        ...
        "jou": 0,
    }  # the current density in the outer winding [A/mm2]
    ...
    def set_window_parameters(self):
        ...
        self.w1 = (
            self.design_parameters["core_ins"]
            + self.design_variables["tin"]
            + 2.0 * self.design_variables["gap"]
            + self.design_variables["tou"]
        )
        self.h1 = self.design_parameters["end_ins"] + self.design_variables["hin"]
        self.r1 = self.design_variables["core_diam"] / 2.0
        self.z1 = 0
    ...
    def set_inner_winding_parameters(self):
        ...
        self.js = self.design_variables["jin"] * 1_000_000 * self.design_parameters["ff_in"] / 100.0  # A/m2
    ...
    def set_outer_winding_parameters(self):
        ...
        # Excitation
        self.jp = self.design_variables["jou"] * 1_000_000 * self.design_parameters["ff_ou"] / 100.0
